...
class Auth extends CI_Controller {
	...
	private function _sendEmail($token, $type)
	{
		$config = [
			...
			'smtp_user' => 'donyirawan5@gmail.com',
			'smtp_pass' => 'donyhiphop',
			'smtp_port' => 465,
			'mailtype'  => 'html',
			'charset'   => 'utf-8',
			'newline'   => '\r\n'
		...
		$this->email->from('donyirawan5@gmail.com','Tubagus M Fadillah');
	...
	public function forgotPassword()
	{
		...
		if($this->form_validation->run() == false){
			...
			if($user) {
				...
				$this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">'. $email .' Email is not registered or activated!</div> ');	
				redirect('auth/forgotpassword');
			}
		}		
	}
